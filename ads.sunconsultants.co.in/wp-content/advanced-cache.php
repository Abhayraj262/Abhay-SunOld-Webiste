...
// WP-Optimize advanced-cache.php (written by version: 3.3.1) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/home/hhzf1sd49q0r/public_html/ads.sunconsultants.co.in/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('https://ads.sunconsultants.co.in/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/home/hhzf1sd49q0r/public_html/ads.sunconsultants.co.in/wp-content/plugins/wp-optimize/cache/extensions');
}

if (!@file_exists(WPO_CACHE_CONFIG_DIR . '/config-ads.sunconsultants.co.in.php')) { return; }

$GLOBALS['wpo_cache_config'] = @json_decode(file_get_contents(WPO_CACHE_CONFIG_DIR . '/config-ads.sunconsultants.co.in.php'), true);

if (empty($GLOBALS['wpo_cache_config'])) {
	include_once(WPO_CACHE_CONFIG_DIR . '/config-ads.sunconsultants.co.in.php');
}
