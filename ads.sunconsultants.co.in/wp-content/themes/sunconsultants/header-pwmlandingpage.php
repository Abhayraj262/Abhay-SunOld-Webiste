			...
			<div class="header-wrap">
				...
				<div class="right-part-section">
					<div class="icon-text-section">
						<div class="icon-wrap">
							<a id="lmpc-header-mobile-ic" href="tel:+917303745057" title="+91-7303745057">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/mob-icon.png" alt="mob-icon">
							</a>	
						</div>
						<div class="text-wrap">
							<p>Have a question?</p>
							<a id="lmpc-header-mobile" href="tel:+917303745057" title="+91-99585 75407">+91-7303745057</a>
						</div>
					</div>
					<div class="icon-text-section">
						<div class="icon-wrap">
