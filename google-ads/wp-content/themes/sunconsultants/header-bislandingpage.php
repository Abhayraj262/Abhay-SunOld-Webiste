...
<script>
  if (window.location.pathname === "/google-ads/bis-certification-consultants/") { 
    document.addEventListener('click', function(e) {
      if (e.target.matches('a[href*="https://wa.me/+919315973373"]')) {
        gtag('event', 'conversion', {
          'send_to': 'AW-11171968373/s7U-CKqTutMZEPXqms8p'
        });
      }
    });
  }
			...
			<div class="header-wrap">
				...
				<div class="right-part-section">
					<div class="icon-text-section">
						<div class="icon-wrap">
							<a id="bis-header-mobile-ic" href="tel:+91931597373" title="+91-9315973373">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/mob-icon.png" alt="mob-icon">
							</a>	
						</div>
						<div class="text-wrap">
							<p>Have a question?</p>
							<a id="bis-header-mobile" href="tel:+919315973373" title="+91-9315973373">+91-9315973373</a>
						</div>
					</div>
					<div class="icon-text-section">
						<div class="icon-wrap">
							<a id="bis-header-email-ic" href="mailto:info@sunconsultants.co.in" title="info@sunconsultants.co.in">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/mail-icon.png" alt="mail-icon">
						</a>
						</div>
						<div class="text-wrap">
							<p>Contact us at</p>
							<a id="bis-header-email" href="mailto:info@sunconsultants.co.in" title="info@sunconsultants.co.in">info@sunconsultants.co.in</a>
						</div>
					</div>
				</div>
			</div>
