...
if (!class_exists('\Wpo\Services\Ajax_Service')) {
    ...
    class Ajax_Service
    {
        ...
        public static function get_wpo_health_messages()
        {
            ...
            self::AJAX_response('OK', '', '', json_encode($wpo365_errors));
        }
        ...
        public static function get_insights()
        {
            ...
            $start_row = intval(sanitize_text_field($_POST['start_row']));
        ...
        public static function get_parseable_options()
        {
            ...
            $aad_options_only = filter_var($_POST['aad_options_only'], FILTER_VALIDATE_BOOLEAN);
        ...
        public static function get_multiple_idps()
        {
            ...
            if (!empty($idps)) {
                array_map(function ($idp) use (&$result) {
