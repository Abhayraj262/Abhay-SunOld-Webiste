...
================================================== -->
  ...
  <link rel="stylesheet" href="/css/style.css">
   ...
   <link href="/assets/img/ll.webp" rel="icon">
 ...
 <section id="topbar" class="topbar d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="mail-list text-center alloff"><span style="margin-inline:1px;color: rgb(255, 255, 255);">
            info@sunconsultants.co.in | Mob: +91-9315973373, 7303745057, 9811320577 </span>
        </div>
 ...
 <header id="header" class="header d-flex align-items-center">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <img src="/assets/img/suncons.png" alt="" style="height: 92px !important;margin-top: 9px !important;">
