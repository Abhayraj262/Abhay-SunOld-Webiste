...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://localhost/connect4resources/backoffice/uploads/',//'/ckfinder/userfiles/',
//	'root'         => 'http://localhost:8081/connectinfosoft.com/citpladmin/uploads/uploads/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
