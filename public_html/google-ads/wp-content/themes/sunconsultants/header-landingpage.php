			...
			<div class="header-wrap">
				...
				<div class="right-part-section">
					<div class="icon-text-section">
						<div class="icon-wrap">
							<a id="cdsco-header-mobile-ic" href="tel:+919315973373" title="+91-9315973373">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/mob-icon.png" alt="mob-icon">
							</a>	
						</div>
						<div class="text-wrap">
							<p>Have a question?</p>
							<a id="cdsco-header-mobile" href="tel:+919315973373" title="+91-9315973373">+91-9315973373</a>
						</div>
					</div>
					<div class="icon-text-section">
						<div class="icon-wrap">
